...
- La liste des paquets dont dépends notre projet!
...
- Dépendances **optionelles**: dépendances non nécessaires mais pouvant ajouter des foncitonalité  (option `--save-optional`)
